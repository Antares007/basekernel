...
static void printf_putchar(char c) { console_putchar(&console_root, c); }

char getchar() { return keyboard_read(0); }

void putchar(char c) { return printf_putchar(c); }

static void printf_putstring(char *s) { console_putstring(&console_root, s); }
